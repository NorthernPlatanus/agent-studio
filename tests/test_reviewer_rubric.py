...
def test_legacy_no_scores_not_blocked():
    v = _parse_verdict('{"decision":"approve","notes":"ok"}')
    assert v["decision"] == "approve"      # no rubric provided -> don't block
...
def test_winner_falls_back_to_stated_then_first():
    passed = {"x": {}, "y": {}}
